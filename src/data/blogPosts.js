...
export const blogPosts = [
  /*{
    ...
    dateISO: '2025-03-15',
    excerpt:
      'Eight years on and still sold out most nights — here\'s what makes Hamilton a once-in-a-generation experience and why it\'s still worth the splurge.',
    content: `Hamilton opened in London in 2017 and hasn't stopped selling out since. I've seen it three times, and every time the lights go down and that opening number starts, something in the room shifts.

**Why it still works**

Lin-Manuel Miranda's genius was to make history feel urgent. The hip-hop score isn't a gimmick — it's a delivery mechanism for ideas that move fast and hit hard. The casting (the founders played by people of colour, the king played for laughs) makes the story feel both timely and timeless.

The current cast is extraordinary. The person playing Hamilton carries the whole show on their shoulders for nearly three hours and makes it look effortless.

**Is it worth the price?**

Full-price tickets run £50–£185. Day seats via the app lottery can get you in for £10. I'd say it's worth full price once, and the lottery is worth doing every time you're in London.

**Who it's for**

Everyone. But especially people who think they don't like musicals. Hamilton is the show that converts people.

**Bottom line:** See it. At least once. Preferably more.`,
  },
  {
    slug: 'west-end-tickets-without-full-price',
    title: 'How to Get West End Tickets Without Paying Full Price',
    tag: 'Guide',
    emoji: '🎟️',
    readTime: 4,
    date: 'February 2025',
    dateISO: '2025-02-20',
    excerpt:
      'Day seats, lottery apps, last-minute deals — every legitimate way to see a West End show without breaking the bank.',
    content: `West End tickets have a reputation for being expensive. And they can be — a premium Saturday night seat for a big show can cost £150+. But there are real ways to pay much less, and I use them all the time.

**1. The official show lottery**

Most big shows (Hamilton, The Lion King, Wicked) run a digital lottery for day seats. Download the TodayTix or Show-Score app, enter the lottery the day before or day of the show, and you could land a front-row seat for £10–25. I've won Hamilton tickets three times this way.

**2. TodayTix Rush tickets**

TodayTix releases a small number of "Rush" tickets every morning for that day's shows. Check the app from 10am. These usually go for £15–35.

**3. TKTS booth at Leicester Square**

The official half-price ticket booth. Shows listed here are often the ones with genuine availability, not just the obscure ones. Discounts run 25–50%. Turn up in person — the queue moves fast.

**4. Day seats at the box office**

Many theatres hold a small number of seats to sell in person on the day, often front row. Arrive early (I aim for 9am for a 7:30pm show). The Lion King does this — I've sat front row for £25.

**5. Midweek matinees**

Tuesday and Wednesday afternoon performances are often £20–30 cheaper than evening shows. If your schedule allows it, this is the easiest saving.

**6. Student / under-30 schemes**

The National Theatre, Donmar, and many West End houses offer deeply discounted tickets for young people. The National has £5 tickets for under-25s. Always worth checking before you pay full price.

**The one thing I'd avoid:** third-party resellers (Viagogo, StubHub for marked-up tickets). You'll pay 2–3x face value and the tickets may not even be valid.`,
  },
  {
    slug: 'best-musicals-first-timers-2025',
    title: 'The Best Musicals for First-Timers (2025 Edition)',
    tag: 'Guide',
    emoji: '⭐',
    readTime: 6,
    date: 'January 2025',
    dateISO: '2025-01-10',
    excerpt:
      'Never seen a West End show before? These are the ones that consistently convert first-timers into lifelong theatre fans.',
    content: `The question I get asked most: "I've never seen a musical before — which one should I see?" Here's my honest answer for 2025.

**The golden rule for first-timers**

Pick a show that matches your actual taste in films or TV — not the one everyone says is the best. If you love action films, don't start with a quiet character study. If you find broad comedy exhausting, don't start with a pantomime.

**For everyone: The Lion King**

I recommend The Lion King to almost every first-timer without hesitation. It's visually stunning in a way that works even if you're sceptical about musicals. The puppetry in the opening number alone tends to convert people. The story is familiar, the music is glorious, and the production values are extraordinary.

**If you want to laugh: Mamma Mia!**

Pure joy. You don't need to like ABBA going in — by the end you will. It's the most fun I've ever had in a theatre. The audience sings along, people dance in the aisles at curtain call. Great for groups and families.

**If you want to cry: Les Misérables**

This one requires a bit more patience in the first act, but the payoff is enormous. I've never been in a performance where people didn't cry during "Bring Him Home." If you're open to being emotionally wrecked in the best possible way, this is your show.

**If you're sceptical about musicals: Hamilton**

The show designed to convert people. The hip-hop score makes it feel different from every other musical. It's fast, funny, and the history actually makes it more interesting, not less.

**If you want spectacle: Back to the Future**

The newest show on this list and one of the most technically impressive things I've seen on a West End stage. If you loved the films, this will delight you. A great choice for people who aren't sure they'll connect with the music — the staging is enough on its own.

**What I'd avoid for a first visit**
