            ...
            {results.map((musical, index) => {
              ...
              return (
                <div key={musical.id} className="relative">
                  ...
                  {/* Lock overlay — shown only on cards 2 & 3 for unauthenticated users */}
                  {isLocked && index === 1 && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center rounded-3xl bg-white/60 backdrop-blur-sm z-10 px-6 text-center gap-4">
                      <div className="bg-white rounded-2xl shadow-lg px-8 py-6 flex flex-col items-center gap-4 max-w-xs w-full">
                        ...
                        <button
                          ...
                          className="flex items-center gap-3 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-medium text-sm px-5 py-2.5 rounded-xl shadow-sm transition-colors w-full justify-center"
                        >
