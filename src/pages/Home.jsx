  ...
  return (
    <div className="w-full flex flex-col items-center gap-2">
      <button
        onClick={handleClick}
        disabled={loading}
        className="flex items-center gap-3 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-medium text-sm px-5 py-2.5 rounded-xl shadow-sm transition-colors w-full justify-center disabled:opacity-60"
      >
        {loading ? (
            ...
            {results.map((musical, index) => {
              ...
              return (
                <div key={musical.id} className="relative">
                  ...
                  {/* Lock overlay — shown only on card 2 for unauthenticated users */}
                  {isLocked && index === 1 && (
